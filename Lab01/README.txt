...
- Nếu không tồn tại file .pem và câu lệnh ssh truy cập vào Private EC2 báo lỗi Permission denied (publickey,gssapi-keyex,gssapi-with-mic). Thì hãy tải file .pem vào thư mục có sẵn sau đó gắn đường dẫn đến file.l .pem đó trong câu lệnh ssh kết nối đến Private EC2.
